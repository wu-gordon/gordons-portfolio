...
function Home() {
  useEffect(() => {
    ...
    const id = window.setTimeout(() => scrollToId('projects'), 80)
    return () => window.clearTimeout(id)
  }, [])

  return (
    <Artboard height={HOME_HEIGHT}>
      <header className="hero">
        <SiteNav
          current="home"
          onProjectsClick={(event: MouseEvent<HTMLAnchorElement>) => {
        ...
        <div className="gallery">
          ...
          <ProjectCard
            ...
            preview={
              <div className="preview-frame preview-caterdash">
                <img
                  className="apple-set"
                  src={img.appleSetCaterdash}
                  alt="CaterDash product screens on Apple devices"
                />
          ...
          <ProjectCard
            ...
            description={
              <>
                <p>
                  Our roommate-friendly solution to easily assign chores, track monthly performance,
                  and split expenses effortlessly.
                </p>
                <p>
                  Awarded <strong>Best Use of CockroachDB Serverless</strong> at Hack the North 2023.
                </p>
              </>
            }
            preview={
